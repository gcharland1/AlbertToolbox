...
\fancypagestyle{logo}{
	...
	\fancyhead[L,LO]{
		\hspace{-1.5cm}
		\includegraphics[height=1.75cm]{images/albert_logo}}
...
\parbox[b]{0.45\linewidth}{%
    \strut 
    \begin{center}
    \includegraphics[height=1.5cm]{images/signature_sam}
    \end{center}
    \hrule\vspace{0.5cm}
    Préparé par:\\
    Samuel L. Robert, ing.\\
...
\hspace{0.05\linewidth} % distance between the two signature blocks
\parbox[b]{0.45\linewidth}{%
    \strut 
    \vspace*{1.5cm}
    \hrule\vspace{0.5cm}
